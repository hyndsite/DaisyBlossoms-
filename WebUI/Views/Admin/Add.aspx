...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset>
            ...
            <div class="editor-field">
                <%: Html.CheckBoxFor(model => model.StockLevelWarning) %>
            ...
            <div class="editor-field">
                <%: Html.CheckBoxFor(model => model.PriceIncludesTax) %>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.ProductWeight) %>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.CubicWeight) %>
            ...
            <div class="editor-field">
                <%: Html.CheckBoxFor(model => model.IncludeLatestProduct) %>
